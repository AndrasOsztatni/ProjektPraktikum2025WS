...
plt.savefig(os.path.join(SCRIPT_DIR, "30mm_in90_3.0_sfft.pdf"), format="pdf")
plt.clf()
...
plt.savefig(os.path.join(SCRIPT_DIR, "30mm_in90_3.0_f(segments).pdf"), format="pdf")
plt.clf()
'''
